...
Matrix<2,1,float> Sensor_angle_Gyro = { 
    0, 
    0,
};
...
Matrix<2, 1, float> x_est{
  0,
  0
};

Matrix<2, 1, float> x_est_next{
  0,
  0
};
...
void sensor_all(){
  ...
  // Get raw sensor data as matrix in rad/s and m/s squared
  ...
  Sensor_Acc(1, 0) = accelerometer[0] * mg_to_si;
  Sensor_Acc(2, 0) = accelerometer[0] * mg_to_si;
