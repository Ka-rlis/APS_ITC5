...
void complementaryFilter() {
  ...
  x_est_next(1, 0) = alpha * (x_est(1, 0) + Sensor_angle_Gyro(2, 0)) + (1 - alpha) * Sensor_angle_Mag(0, 0);
...
void loop() {
  ...
  pwmMap(u_e(0,0));
  pwmMap(u_e(1,0));
  //Serial.print("Output 1 :  "); Serial.print(pwmMap(u_e(0,0)));
  //Serial.print("    Output 2 :  "); Serial.println(pwmMap(u_e(1,0)));
